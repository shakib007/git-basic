            ...
            if (defaultTenantFile.exists()) {
                ...
                if (UtilValidate.isEmpty(defaultTenant)) {
                    ...
                    for (String defaultTenantComponentName : defaultTenantComponentNames) {
                        ...
                        GenericValue tenantComponent = baseDelegator.makeValue("TenantComponent", UtilMisc.toMap("tenantId", DEFAULT_TENANT_ID, "componentName", defaultTenantComponentName));
