    ...
    public static Map<String, Object> getTenantComponentDataReaders(DispatchContext ctx, Map<String, Object> context) {
        ...
        try {
            ...
            if ("Y".equals(isDemo)) {
                ...
                List<GenericValue> tenantComponents = baseDelegator.findList("TenantComponent", EntityCondition.makeCondition("tenantId", tenantId), null, UtilMisc.toList("sequenceNum"), null, false);
